...
class StatsScreen extends StatefulWidget {
  ...
  required this.currentStreak,
    required this.deepBreathsTaken,
    required this.sessionTime,
  });

  final String title;
  final String sessionTime;
  final String deepBreathsTaken;
                ...
                TextButton(
                  onPressed: () {
                    setState(() {
                      ...
                      time = "1:20";
                      deepNum =
                        // widget.sessionTime.inMinutes.toString().padLeft(2, '0') +
                        //     ':' +
                        //     (widget.sessionTime.inSeconds % 60).toString().padLeft(2, '0'),
                        // style: TextStyle(
                        //   fontSize: 25,
                        // );
